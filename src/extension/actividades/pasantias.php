...
<head>
   ...
   <link href="./styles/pasantias.css" rel="stylesheet">
   ...
   <div>
            ...
            <div class="row">
               <div class="col-1">
                  ...
                  <div id="wb_LayoutGrid6">
                     <form name="LayoutGrid6" method="post" action="mailto:yourname@yourdomain.com" enctype="text/plain"
                        ...
                        <div class="row">
                           <div class="col-1">
                              <div id="wb_Text1">
                                 <span style="color:#000000;font-family:Roboto;font-size:17px;"><strong>Institución
                                       u organización</strong></span>
                              </div>
                              <input type="text" id="Editbox2" style="display:block;width: 100%;height:42px;z-index:14;"
                                 name="nombre" value="" spellcheck="false"
                                 placeholder="Nombre de la institución u organización">
                           </div>
                           <div class="col-2">
                              <div id="wb_Text2">
                                 <span
                                    style="color:#000000;font-family:Roboto;font-size:17px;"><strong>Lugar</strong></span>
                              </div>
                              <input type="text" id="Editbox3" style="display:block;width: 100%;height:42px;z-index:16;"
                                 name="lugar" value="" spellcheck="false"
                                 placeholder="Lugar donde se realizó la pasantía (país, lugar)">
                           </div>
                        </div>
                     </form>
                  </div>
                  <div id="wb_LayoutGrid9">
                     <form name="LayoutGrid6" method="post" action="mailto:yourname@yourdomain.com" enctype="text/plain"
                        id="LayoutGrid9" onsubmit="return submitLayoutGrid6()">
                        <div class="row">
                           <div class="col-1">
                              <div id="wb_Text4">
                              ...
                              <input type="date" id="Editbox4" style="display:block;width: 100%;height:42px;z-index:18;"
                                 name="f_inicio" value="" spellcheck="false" placeholder="Fecha de inicio">
                           </div>
                           <div class="col-2">
                              <div id="wb_Text5">
                                 <span style="color:#000000;font-family:Roboto;font-size:17px;"><strong>Fecha
                              ...
                              <input type="date" id="Editbox5" style="display:block;width: 100%;height:42px;z-index:20;"
                                 name="f_fin" value="" spellcheck="false" placeholder="Fecha de finalización">
                           </div>
                           <div class="col-3">
                           </div>
                        </div>
                     ...
                     <div id="LayoutGrid12">
                        <div class="row">
                           <div class="col-1">
                              ...
                              <textarea name="TextArea1" id="TextArea5"
                                 style="display:block;width: 100%;;height:99px;z-index:22;" rows="4" cols="155"
                                 autocomplete="off" spellcheck="false"
                                 placeholder="Descripción del proyecto (incluyendo involucrados)"></textarea>
                           </div>
                        </div>
                     </div>
                  </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-2">
                              ...
                              <textarea name="o_general" id="TextArea3"
                                 style="display:block;width: 100%;;height:99px;z-index:26;" rows="4" cols="32"
                                 autocomplete="off" spellcheck="false"
                           ...
                           <div class="col-3">
                              ...
                              <textarea name="o_especifico" id="TextArea4"
                                 style="display:block;width: 100%;;height:99px;z-index:28;" rows="4" cols="32"
                                 autocomplete="off" spellcheck="false"
                     ...
                     <div id="LayoutGrid11">
                        <div class="row">
                           <div class="col-1">
                              ...
                              <textarea name="alcance" id="TextArea1"
                                 style="display:block;width: 100%;;height:99px;z-index:30;" rows="4" cols="73"
                                 autocomplete="off" spellcheck="false" placeholder="Alcance del proyecto "></textarea>
                           </div>
                           <div class="col-2">
                              <div id="wb_Text15">
                                 <span style="color:#000000;font-family:Roboto;font-size:17px;"><strong>Beneficiarios
                                       de los resultados del proyecto</strong></span>
                              </div>
                              <textarea name="benf_proyec" id="TextArea2"
                                 style="display:block;width: 100%;;height:99px;z-index:32;" rows="4" cols="73"
                                 autocomplete="off" spellcheck="false"
                                 placeholder="Beneficiarios del proyecto "></textarea>
                           </div>
                        </div>
                     </div>
                  </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-3">
                              ...
                              <div id="FileUpload5" class="input-group"
                                 ...
                                 <input class="form-control" type="text" readonly="">
                                 <label class="input-group-btn">
                                    <input type="file" name="adj5" id="FileUpload5-file" style="display:none;"><span
                                       class="btn">Adjuntar...</span>
                                 </label>
                              </div>
                           </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-2">
                              <a id="Button2" href="" onclick="$('#Toast1').toast('show');return false;"
                                 ondblclick="window.location.href='./pasantias.php';return false;"
      ...
      <div id="wb_LayoutGrid16">
         <div id="LayoutGrid16">
            <div class="row">
               <div class="col-1">
                  <hr id="Line3" style="display:block;width: 100%;z-index:78;">
               </div>
            </div>
         </div>
      </div>
                     ...
                     <div id="LayoutGrid28">
                        <div class="row">
                           <div class="col-1">
                              ...
                              <hr id="Line4" style="display:inline-block;width:590px;z-index:83;">
                           </div>
                        </div>
                     </div>
                  </div>
                           ...
                           <div class="col-1">
                              <div class="col-1-padding">
                                 <div id="wb_IconFont11"
                                    style="display:inline-block;width:45px;height:20px;text-align:center;z-index:84;">
                                    <div id="IconFont11"><i class="fa fa-envelope"></i></div>
                                 </div>
                                 <div id="wb_IconFont13"
                                    style="display:inline-block;width:45px;height:20px;text-align:center;z-index:85;">
                                    <div id="IconFont13"><i class="fa fa-facebook-square"></i></div>
                                 </div>
                                 <div id="wb_IconFont14"
                                    style="display:inline-block;width:45px;height:20px;text-align:center;z-index:86;">
                                    <div id="IconFont14"><i class="fa fa-instagram"></i></div>
                                 </div>
                                 <div id="wb_IconFont15"
                                    style="display:inline-block;width:45px;height:20px;text-align:center;z-index:87;">
                                    <div id="IconFont15"><i class="fa fa-twitter"></i></div>
                                 </div>
                                 <div id="wb_IconFont16"
                                    style="display:inline-block;width:45px;height:20px;text-align:center;z-index:88;">

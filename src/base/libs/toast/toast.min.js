...
(function (b, e) {
  "object" === typeof exports && "undefined" !== typeof module
    ...
    : ((b = b || self), (b.Toast = e(b.jQuery, b.Util)));
})(this, function (b, e) {
  function k(b, c) {
  ...
  function h(b) {
    for (var c = 1; c < arguments.length; c++) {
      ...
      c % 2
        ? l(Object(a), !0).forEach(function (d) {
            var c = a[d];
            d in b
              ? Object.defineProperty(b, d, { value: c, enumerable: !0, configurable: !0, writable: !0 })
              : (b[d] = c);
          })
        : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(b, Object.getOwnPropertyDescriptors(a))
        : l(Object(a)).forEach(function (d) {
            Object.defineProperty(b, d, Object.getOwnPropertyDescriptor(a, d));
          });
    }
    return b;
  }
  ...
  var p = b.fn.toast,
    q = { animation: "boolean", autohide: "boolean", delay: "number" },
    ...
    g = (function () {
        ...
        if (!d.isDefaultPrevented())
          if (
            ...
            (d = function () {
              ...
              b(a._element).trigger("shown.bs.toast");
              a._config.autohide &&
            ...
            b(this._element).one(e.TRANSITION_END, d).emulateTransitionEnd(c);
          } else d();
      };
      c.hide = function () {
      ...
      c._getConfig = function (a) {
        a = h(h(h({}, m), b(this._element).data()), "object" === typeof a && a ? a : {});
        e.typeCheckConfig("toast", a, this.constructor.DefaultType);
        return a;
      };
      ...
      c._close = function () {
        var a = this,
          d = function () {
            ...
            b(a._element).trigger("hidden.bs.toast");
          };
      ...
      f._jQueryInterface = function (a) {
        return this.each(function () {
          var d = b(this),
            c = d.data("bs.toast"),
            e = "object" === typeof a && a;
          c || ((c = new f(this, e)), d.data("bs.toast", c));
          if ("string" === typeof a) {
  ...
  b.fn.toast = g._jQueryInterface;
  b.fn.toast.Constructor = g;

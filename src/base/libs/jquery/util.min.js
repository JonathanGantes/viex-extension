...
(function (b, c) {
  ...
  var c = {
    ...
    getSelectorFromElement: function (a) {
      ...
      (b && "#" !== b) || (b = (a = a.getAttribute("href")) && "#" !== a ? a.trim() : "");
      try {
    ...
    getTransitionDurationFromElement: function (a) {
      ...
      a = b(a).css("transition-delay");
      var e = parseFloat(c),
        f = parseFloat(a);
      if (!e && !f) return 0;
      c = c.split(",")[0];
      a = a.split(",")[0];
      return 1e3 * (parseFloat(c) + parseFloat(a));
    },
    reflow: function (a) {
    ...
    typeCheckConfig: function (a, b, e) {
      for (var f in e)
        if (Object.prototype.hasOwnProperty.call(e, f)) {
          ...
          if (!new RegExp(g).test(d))
            throw Error(
              a.toUpperCase() + ': Option "' + (f + '" provided type "' + d + '" but expected type "') + (g + '".')
            );
        }
    },
    ...
    jQueryDetection: function () {
      ...
      if ((2 > a[0] && 9 > a[1]) || (1 === a[0] && 9 === a[1] && 1 > a[2]) || 4 <= a[0])
  ...
  b.fn.emulateTransitionEnd = function (a) {
    var h = this,
      e = !1;
    b(this).one(c.TRANSITION_END, function () {
      e = !0;
    });
    setTimeout(function () {
      e || c.triggerTransitionEnd(h);
    }, a);
    return this;
  };
  b.event.special[c.TRANSITION_END] = (function () {
    return {

...
<head>
    ...
    <link href="./styles/registro_exitoso.css" rel="stylesheet">
</head>
...
<body>
                            ...
                            <div class="col-1">
                                <div class="col-1-padding">
                                    <div id="wb_Image1" style="display:inline-block;width:100%;height:auto;z-index:0;">
                                        <a href="../index.php"><img src="../base/images/tareas/viex-header.png"
                                                id="Image1" alt="" width="736" height="75"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-2">
    ...
    <div id="wb_LayoutGrid6">
        <div id="LayoutGrid6">
            <div class="row">
                <div class="col-1">
                    <div id="wb_Text1">
                        <span style="color:#0E733A;font-family:'Roboto';font-weight:900;font-size:35px;">REGISTRO
                            EXITOSO, VERIFIQUE SU E-MAIL PARA COMPROBAR SU DIRECCIÓN</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="wb_LayoutGrid7">
        <div id="LayoutGrid7">
            <div class="row">
                <div class="col-1">
                    <div id="wb_IconFont1"
                        style="display:inline-block;width:147px;height:111px;text-align:center;z-index:6;">
                        <div id="IconFont1"><i class="fa fa-check"></i></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="wb_LayoutGrid22">
        <div id="LayoutGrid22">
            <div class="row">
                ...
                <div class="col-2">
                    <div id="wb_Breadcrumb1" style="display:inline-block;width:100%;z-index:7;vertical-align:top;">
                        <ul id="Breadcrumb1">
                            <li><a href=""><i class="fa fa-envelope">&nbsp;</i> Ir a correo</a></li>
                        </ul>

                    </div>
                </div>
                <div class="col-3">
                    <div id="wb_Breadcrumb2" style="display:inline-block;width:100%;z-index:8;vertical-align:top;">
                        <ul id="Breadcrumb2">
    ...
    <div id="wb_LayoutGrid16">
        <div id="LayoutGrid16">
            <div class="row">
                <div class="col-1">
                    <hr id="Line3" style="display:block;width: 100%;z-index:9;">
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div id="LayoutGrid28">
                            <div class="row">
                                <div class="col-1">
                                    ...
                                    <hr id="Line4" style="display:inline-block;width:590px;z-index:14;">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-1">
                                    <div class="col-1-padding">
                                        <div id="wb_IconFont11"
                                            style="display:inline-block;width:45px;height:20px;text-align:center;z-index:15;">
                                            <div id="IconFont11"><i class="fa fa-envelope"></i></div>
                                        </div>
                                        <div id="wb_IconFont13"
                                            style="display:inline-block;width:45px;height:20px;text-align:center;z-index:16;">
                                            <div id="IconFont13"><i class="fa fa-facebook-square"></i></div>
                                        </div>
                                        <div id="wb_IconFont14"
                                            style="display:inline-block;width:45px;height:20px;text-align:center;z-index:17;">
                                            <div id="IconFont14"><i class="fa fa-instagram"></i></div>
                                        </div>
                                        <div id="wb_IconFont15"
                                            style="display:inline-block;width:45px;height:20px;text-align:center;z-index:18;">
                                            <div id="IconFont15"><i class="fa fa-twitter"></i></div>
                                        </div>
                                        <div id="wb_IconFont16"
                                            style="display:inline-block;width:45px;height:20px;text-align:center;z-index:19;">
